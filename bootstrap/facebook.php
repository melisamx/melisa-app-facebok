...
require_once __DIR__ . '/../App/Facebook/Application.php';

$app = new App\Facebook\Application(
    [
        'base'=>  realpath(__DIR__ . '/../App/Facebook'),
        'storage'=> realpath(__DIR__ . '/../App/Facebook/storage'),
